  ...
  include './DB/DBconnection.php';
    ...
    if($result->num_rows>0){
      while($row=$result->fetch_assoc()){
        if ($row['branch'] == $branch && ($row['semester'] == '1' || $row['semester'] == '2')) {
            $totalAtt1++;
            if ($row['attendance'] == 'P') {
                $sem1Att++;
            }
        } elseif ($row['branch'] == $branch && ($row['semester'] == '3' || $row['semester'] == '4')) {
            $totalAtt2++;
            if ($row['attendance'] == 'P') {
                $sem2Att++;
            }
        } elseif ($row['branch'] == $branch && ($row['semester'] == '5' || $row['semester'] == '6')) {
            $totalAtt3++;
            if ($row['attendance'] == 'P') {
                $sem3Att++;
            }
            ...
            <div class="card shadow-sm border-primary">
              ...
              <div class="card-body">
                ...
                <div class="bg-light p-3 rounded text-center border">
                  <h4 class="text-primary mb-0"><?php echo ($totalAtt1 > 0) ? round(($sem1Att / $totalAtt1) * 100) . "%" : "N/A"; ?></h4>
          ...
          <div class="col">
            <div class="card shadow-sm border-primary">
              ...
              <div class="card-body">
                <h5 class="card-title text-center">Daily Attendance</h5>
                <div class="bg-light p-3 rounded text-center border">
                  <h4 class="text-primary mb-0"><?php echo ($totalAtt2 > 0) ? round(($sem2Att / $totalAtt2) * 100) . "%" : "N/A"; ?></h4>
                  <small class="text-muted">Updated Today</small>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card shadow-sm border-primary">
              ...
              <div class="card-body">
                <h5 class="card-title text-center">Daily Attendance</h5>
                <div class="bg-light p-3 rounded text-center border">
                  <h4 class="text-primary mb-0"><?php echo ($totalAtt3 > 0) ? round(($sem3Att / $totalAtt3) * 100) . "%" : "N/A"; ?></h4>
                  <small class="text-muted">Updated Today</small>
                </div>
              </div>
            </div>
