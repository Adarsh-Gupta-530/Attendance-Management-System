...
<html lang="en">
  <head>
    ...
    <title>Progressive Test Result</title>
  ...
  <body>
    <?php 
     ...
     $B = $_GET['B'];
     if($B=='GEN'){
      $sql = "SELECT * FROM assign INNER JOIN subject ON assign.sub_id = subject.sub_id WHERE assign.semester='1' || assign.semester='2' ORDER BY assign.semester ASC;" ;
     }else{

       $sql = "SELECT * FROM assign INNER JOIN subject ON assign.sub_id = subject.sub_id WHERE Abranch ='$B' ORDER BY assign.semester ASC;" ;
     }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $subject = $_POST['subject'];
        ...
        header("location: viewProgressiveTestResult2.php");
    }
    ?>
    ...
    <nav class="navbar navbar-light bg-white shadow-sm px-4">
      <div class="container-fluid d-flex align-items-center">
        ...
        <h5 class="mb-0 fw-bold">Progressive Test Result</h5>
      </div>
    </nav>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: calc(100vh - 100px);">
      <div class="card shadow p-4" style="width: 100%; max-width: 500px; border-radius: 12px;">
        <h4 class="text-center fw-bold mb-4">Progressive Test Result</h4>
        <form method="POST" action="viewProgressiveTestResult.php">
          <div class="mb-3">
