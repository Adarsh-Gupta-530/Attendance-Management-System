<?php
  ...
  $sql = "SELECT user_id, faculty_name, branch, designation, pass FROM faculty ORDER BY branch ASC";
...
<head>
  ...
  <link rel="stylesheet" href="./css/hodFacultyTable.css">
</head>
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <a href="adminUpdateFaculty.php?Fid=<?php echo $row['user_id']; ?>" class="btn btn-warning btn-sm">Update</a>
                    </td>
                  </tr>
              <?php
                  }
