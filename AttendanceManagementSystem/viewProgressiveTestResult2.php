...
if($_SESSION['loggedin']!=true){
    header("location: viewProgressiveTestResult.php");
    exit;
}
?>
<!doctype html>
<html lang="en">
  ...
  <?php 
      ...
      $sql="SELECT * FROM attendance INNER JOIN subject ON subject.sub_id = attendance.sub_id 
      INNER JOIN student ON student.roll_no = attendance.roll_no WHERE 
  ...
  <nav class="navbar bg-white shadow-sm mb-4">
        <div class="container-fluid d-flex justify-content-between align-items-center px-5">
          ...
          <div class="text-end">
            <p class="mb-0 fw-semibold">Student's Progressive Test Result</p>
          </div>
        </div>
    </nav>
  <div class="mx-4 "> 
          ...
          <table class="table table-bordered align-middle text-center">
            <thead class="table-light">
              <tr>
                ...
                <th >Roll No.</th>
                <th >Student Name</th>
                <th>Progressive Test 1</th>
                <th>Progressive Test 2</th>
                <th>Makeup Test</th>
              </tr>
            </thead>
            <tbody>
