<?php
  ...
  $sql = "SELECT user_id, faculty_name, branch, designation, pass FROM faculty WHERE branch='$branch' AND designation='Teacher'";
...
<!-- Navbar -->
 <nav class="navbar navbar-light bg-white shadow-sm px-4">
      <div class="container-fluid d-flex align-items-center">
        ...
        <h5 class="mb-0 fw-bold">Faculty Detail's</h5>
      </div>
    </nav>
...
<main class="container my-4 flex-grow-1">
  <div class="card shadow-sm">
    <div class="card-body">
      <h3 class="text-center mb-4">Faculty List - <?php echo htmlspecialchars($branch); ?></h3>
          ...
          <tbody>
            <?php
              if($result->num_rows > 0){
                ...
                echo "<tr><td colspan='6'>No faculty data found.</td></tr>";
              }
              $conn->close();
            ?>
          </tbody>
